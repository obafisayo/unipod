    ...
    <main data-screen-label="master-plan" className="block bg-[#fff]">
      ...
      <section className="relative bg-brand-dark text-white overflow-hidden">
        <Image
          ...
          src="/assets/mural-lounge.jpg"
          alt="Unipod Masterplan mural"
          fill
        />
        ...
        <div className="relative z-3 max-w-1024 mx-auto pt-[14rem] md:pt-[20rem] px-(--content-padding) pb-[6rem] md:pb-[8rem]">
          ...
          <p className="mt-12 max-w-[60rem] text-[1.6rem] md:text-[18px] leading-normal text-[rgba(255,255,255,0.85)]">
            AI isn't something that happens to us. It's something we build. Our
            master plan outlines the strategic bets we're making to ensure
            African talent leads the next decade of automation.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-1024 mx-auto w-full reveal opacity-0 translate-y-[2.4rem] [&.in]:opacity-100 [&.in]:translate-y-0 transition-all duration-900 ease-[cubic-bezier(0.16,1,0.3,1)]">
          ...
          <div className="flex flex-col gap-8 justify-end">
            <p className="m-0 text-[1.6rem] leading-normal max-w-[46rem]">
              The master plan is a living document. We are actively seeking
              faculty, industry partners, and policy makers to help refine our
              execution.
            </p>
          </div>
