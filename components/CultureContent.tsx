  ...
  return (
    <div className="rich-text-page-content__content p-[0_var(--content-padding)_6rem] md:p-[0_var(--content-padding)_12rem]">
      <div className="rich-text-page-content__content-inner w-full max-w-1024 mx-auto lg:grid lg:gap-24 lg:grid-cols-[minmax(50rem,1fr)_minmax(0,45rem)] xl:gap-56">
        <div className="rich-text-page-content__article-author-container">
          <article className="rich-text-page-content__rich-text-area whitespace-break-spaces [&>*:first-child]:mt-24 md:[&>*:first-child]:mt-36 lg:[&>*:first-child]:mt-48">
            <h2 className="rich-text-heading rich-text-heading--h2 relative font-neue-haas text-[2.4rem] font-normal leading-[1.1] tracking-[-0.01em] m-[6rem_0_2rem] md:text-[3.6rem] md:m-[12rem_0_3rem]">
              <span id="origin" className="rich-text-heading-anchor absolute -top-60 left-0"></span>
              Origin
            </h2>
            ...
            <h2 className="rich-text-heading rich-text-heading--h2 relative font-neue-haas text-[2.4rem] font-normal leading-[1.1] tracking-[-0.01em] m-[6rem_0_2rem] md:text-[3.6rem] md:m-[12rem_0_3rem]">
              <span id="mission" className="rich-text-heading-anchor absolute -top-60 left-0"></span>
              Mission
            </h2>
            ...
            <h2 className="rich-text-heading rich-text-heading--h2 relative font-neue-haas text-[2.4rem] font-normal leading-[1.1] tracking-[-0.01em] m-[6rem_0_2rem] md:text-[3.6rem] md:m-[12rem_0_3rem]">
              <span id="vision" className="rich-text-heading-anchor absolute -top-60 left-0"></span>
              Vision
            </h2>
            ...
            <h2 className="rich-text-heading rich-text-heading--h2 relative font-neue-haas text-[2.4rem] font-normal leading-[1.1] tracking-[-0.01em] m-[6rem_0_2rem] md:text-[3.6rem] md:m-[12rem_0_3rem]">
              <span id="values" className="rich-text-heading-anchor absolute -top-60 left-0"></span>
              Values
            </h2>
            ...
            <p className="rich-text-paragraph font-neue-haas text-[1.7rem] font-normal leading-[160%] tracking-[-0.01em] md:text-[1.9rem]">If you share our commitment to building a better future, please apply on our <a className="rich-text-link" href="/proposals">proposals page.</a></p>
        ...
        <div className="rich-text-page-content__side-nav-container transition-opacity duration-300 ease-in-out z-250 fixed top-6 w-[calc(100%-14rem)] left-28 w-[28rem] md:top-16 md:left-auto md:right-16 lg:w-full lg:sticky lg:h-max lg:right-auto lg:top-10 lg:mt-40">
