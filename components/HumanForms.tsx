    ...
    <section className="relative pt-32 px-(--content-padding) pb-10 bg-brand-cream md:pt-64">
      ...
      <div className="relative z-2 grid grid-cols-1 gap-36 mx-auto max-w-1024 md:gap-0 lg:grid-cols-[minmax(0,.5fr)_minmax(0,.5fr)]">
        <div className="flex flex-col gap-[2.4rem] w-full md:gap-[3.2rem]">
            <h1 className="font-machina font-normal text-[4.2rem] leading-none tracking-[-0.01em] uppercase m-0 md:text-[8.5rem] font-features-['ss12'_on]" >Inside the<br />Unipod</h1>
            <p className="font-neue-haas text-[1.4rem] leading-normal tracking-[-0.01em] m-0 md:text-[1.6rem] max-w-136">A multi-disciplinary innovation facility built for student founders — powered by UNDP and accredited by the University of Lagos.</p>
        </div>
        <dl className="m-0 p-0 md:pt-36" >
      ...
      <Image 
        className="absolute bottom-0 left-0 max-w-150 w-full h-240 object-contain object-bottom-left z-1 aspect-800/1330 md:max-w-full md:h-[90%] md:object-bottom md:aspect-1440/1169" 
        src={HumanoidMobile} 
        width={800} 
        height={1330} 
