...
function CareerListA({ text, href }: CareerListAProps) {
  ...
  return (
    ...
    >
      <address className="transition-opacity duration-300 ease-in-out font-neue-haas text-[1.4rem] font-medium leading-[1.2] tracking-normal text-white opacity-60 not-italic block">Sunnyvale, CA</address>
