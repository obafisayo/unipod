        ...
        <div className="metrics-module__inner w-full max-w-[144rem] mx-auto relative">
          ...
          <dl className="metrics-module__list m-0 p-0 list-none grid grid-cols-1 flex-col gap-[4rem] md:grid-cols-3 md:flex-row md:gap-8 md:items-center md:justify-center">
            <div className="metrics-module__item m-0 text-left">
              <dt className="metrics-module__item-title inline-block font-machina text-[7rem] font-normal leading-none tracking-[-0.01em] text-transparent bg-clip-text [-webkit-background-clip:text] md:text-[15rem] bg-[linear-gradient(270deg,#23B7CA_0%,#FDAB3B_100%)] font-features-['ss12'_on]" >40</dt>
            ...
            <div className="metrics-module__item m-0 text-left md:text-center">
              <dt className="metrics-module__item-title inline-block font-machina text-[7rem] font-normal leading-none tracking-[-0.01em] text-transparent bg-clip-text [-webkit-background-clip:text] md:text-[15rem] bg-[linear-gradient(270deg,#23B7CA_0%,#FDAB3B_100%)] font-features-['ss12'_on]" >100+</dt>
            ...
            <div className="metrics-module__item m-0 text-left md:text-right">
              <dt className="metrics-module__item-title inline-block font-machina text-[7rem] font-normal leading-none tracking-[-0.01em] text-transparent bg-clip-text [-webkit-background-clip:text] md:text-[15rem] bg-[linear-gradient(270deg,#23B7CA_0%,#FDAB3B_100%)] font-features-['ss12'_on]" >&lt;2</dt>
