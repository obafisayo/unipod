...
function ModalButton({ ariaLabel, onClick }: ModalButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className="transition-colors duration-300 ease-in-out absolute top-[2rem] right-[2rem] p-0 w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] text-[#0c0c0c] bg-white rounded-[0.4rem] border-none cursor-pointer hover:bg-[#797af2] group"
    >
