...
function ModalButton({ ariaLabel, onClick }: ModalButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className="transition-colors duration-300 ease-in-out absolute top-8 right-8 p-0 w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] text-brand-dark bg-white rounded-[0.4rem] border-none cursor-pointer hover:bg-[#23B7CA] group"
    >
