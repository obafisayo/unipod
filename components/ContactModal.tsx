  ...
  return (
    <div className="p-[8rem_2rem] md:p-[6rem_2rem] h-full overflow-y-auto">
      <div className="flex flex-col">
        <div className="flex flex-col gap-[3rem] md:gap-[4.2rem]">
          <div className="flex flex-col gap-[2rem] md:gap-[3rem]">
            ...
            <div className="font-neue-haas text-[1.4rem] md:text-[1.6rem] leading-[1.5] tracking-[-0.01em] m-0">We&apos;ll get back to you as soon as possible.</div>
          </div>
          <form noValidate className="flex flex-col gap-[1.5rem] md:gap-[2rem]" aria-label="Send us a message">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] w-full">
            ...
            <div className="grid grid-cols-1 gap-[2rem] w-full">
              <div className="w-full">
