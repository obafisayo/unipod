  ...
  return (
    <li className="inline-static-timeline__item flex flex-col">
      <article className="inline-static-timeline__inner-wrapper h-full flex flex-col">
        <div className="inline-static-timeline__item-inner relative rounded-[0.5rem] p-[2.6rem_3.2rem] h-full bg-[linear-gradient(180deg,#ff38bb_5%,#ff8038_55%,#f5be66_65%,#f1fff7_93%)]" >
