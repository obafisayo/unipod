...
function MasterplanTimeline() {
  return (
    <section className="inline-static-timeline bg-brand-dark text-white p-[4rem_var(--content-padding)] w-[calc(100%+var(--content-padding)*2)] ml-[calc(var(--content-padding)*-1)] md:ml-0 md:w-full md:p-[8rem_4rem]">
      ...
      <div className="inline-static-timeline__sub-text w-full flex items-center justify-between mb-[2.4rem]">
        <p className="inline-static-timeline__sub-text-left font-neue-haas text-[1.4rem] leading-normal tracking-[-0.01em]">
          More Structured <br />
          Less Variability
        </p>
        <p className="inline-static-timeline__sub-text-right hidden font-neue-haas text-[1.4rem] leading-normal tracking-[-0.01em] md:block lg:hidden">
          Less Structured <br />
          More Variability
        </p>
      </div>
      <ul className="inline-static-timeline__items p-0 m-0 list-none grid grid-cols-1 gap-12 md:grid-cols-3 md:gap-x-[2rem] md:gap-y-[3rem] lg:grid-cols-1 lg:gap-12 xl:gap-x-[2rem] xl:gap-y-[3rem]">
      ...
      <p className="inline-static-timeline__sub-text-right-mobile block mt-[3.4rem] font-neue-haas text-[1.4rem] leading-normal tracking-[-0.01em] md:hidden lg:block">
        Less Structured <br />
        More Variability
      </p>
    </section>
