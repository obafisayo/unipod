...
function Author() {
  return (
    <div className="author grid grid-cols-[minmax(0,11.5rem)_1fr] gap-[2rem] items-center mt-[3rem]">
      <div className="author__image-container w-full">
        <Image 
          ...
          width={230} height={230} decoding="async" className="author__image w-full h-auto" loading="lazy" style={{ color: 'transparent' }}
        />
      </div>
      <div className="author__about-content -mt-[0.5rem]">
        <Image 
          ...
          width={240} height={53} decoding="async" className="author__signature w-[17rem] h-auto" loading="lazy" style={{ color: 'transparent' }}
        />
        <address className="author__name-title font-neue-haas text-[1.4rem] font-medium leading-[1.2] tracking-[0] not-italic mt-[0.5rem]">
