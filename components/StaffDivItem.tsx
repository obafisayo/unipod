        ...
        <span className="team-member__text pt-[2rem] block grid-cols-1">
          <Slider icon plus sb
            text={<span className="team-member__name-title-container text-left block">
              <span className="team-member__name font-neue-haas text-[1.8rem] font-normal leading-[1.5] tracking-[-0.01em] m-[0_0_0.7rem] block md:text-[2.2rem] md:leading-[1.1]">{name}</span>
              <span className="team-member__title font-neue-haas text-[1.4rem] font-medium leading-[1.2] tracking-[0] m-0 block">{title}</span>
            </span>}
          />
        </span>
      </span>
